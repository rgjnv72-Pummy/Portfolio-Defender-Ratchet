...
FALLBACK_HOLDINGS = {
    ...
    "LTFOODS.NS": {"quantity": 350, "avg_cost": 444.71, "buy_date": "2026-09-03", "sector": "Fast Moving Consumer Goods", "strategy": "swing"},
    "ZYDUSWELL.NS": {"quantity": 200, "avg_cost": 540.00, "buy_date": "2026-09-04", "sector": "Fast Moving Consumer Goods", "strategy": "swing"},
    "ATHERENERG.NS": {"quantity": 100, "avg_cost": 1591.00, "buy_date": "2026-09-09", "sector": "Auto Components", "strategy": "swing"},
    "HINDCOPPER.NS": {"quantity": 300, "avg_cost": 539.00, "buy_date": "2026-09-09", "sector": "Metals & Mining", "strategy": "swing"},
    "RADICO.NS": {"quantity": 40, "avg_cost": 4430.00, "buy_date": "2026-09-10", "sector": "Fast Moving Consumer Goods", "strategy": "swing"}
}
...
def load_live_portfolio() -> Dict[str, Dict[str, Any]]:
    ...
    try:
        ...
        return formatted_holdings if formatted_holdings else FALLBACK_HOLDINGS
